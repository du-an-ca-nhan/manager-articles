...
public enum Message {
    ...
    CONTENT_IS_NOT_NULL(PropertiesReader.getProperty(PropertyKeys.CONTENT_IS_NOT_NULL)),

    FEEDBACK_IS_NOT_NULL(PropertiesReader.getProperty(PropertyKeys.FEEDBACK_IS_NOT_NULL));
//    ERROR_UNKNOWN("Error Unknown"),
