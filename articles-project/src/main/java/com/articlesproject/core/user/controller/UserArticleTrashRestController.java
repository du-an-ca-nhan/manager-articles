...
public class UserArticleTrashRestController extends BaseController {
    ...
    @DeleteMapping("/delete-articles/{ids}")
    private ResponseObject deleteAllArticleByIdIn(@PathVariable("ids") String[] ids){
        return new ResponseObject(userArticleTrashService.deleteAllArticleByIdIn(ids));
    }
}
