...
public class UserMyArticleRestController extends BaseController {
    ...
    public ResponseObject updateArticle(@Valid @PathVariable("id") String id, @RequestBody UserUpdateArticleRequest request) throws IOException {
    ...
    public ResponseObject updateArticleToCensor(@Valid @PathVariable("id") String id, @RequestBody UserUpdateArticleRequest request) throws IOException {
    ...
    @DeleteMapping("/delete-article-to-trash/{id}")
    public ResponseObject deleteArticleToTrash(@PathVariable("id") String id) {
        return new ResponseObject(userMyArticleService.deleteArticleToTrash(id));
    }
